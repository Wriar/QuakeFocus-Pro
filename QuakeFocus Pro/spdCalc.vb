...
Public Class spdCalc
    ...
    Public Shared Function calculateArrivalTime(originTime As DateTime, currentTime As DateTime, evLong As String, evLat As String, usrLat As String, usrLong As String, hypoDepth As String)
        ...
        Return subtractPArriveTime & "," & subtractSArriveTime
